...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mixalis/Documents/Test/Laravel/todolist2/public/storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mixalis/Documents/Test/Laravel/todolist2/public/storage','logging.default','logging.deprecations.channel',
...
'cors.max_age','cors.supports_credentials','view.paths','view.compiled','broadcasting.default',
...
'web','api',);
        registerArgumentsSet('routes', 'tasks.index','tasks.create','tasks.store',
'tasks.show','tasks.edit','tasks.update','tasks.destroy','storage.local',);
        registerArgumentsSet('views', 
'components.layout','pagination::bootstrap-4','pagination::bootstrap-5','pagination::default','pagination::semantic-ui',
...
'tasks.index','tasks.show','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.default',
...
'vendor.pagination.tailwind','welcome','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
